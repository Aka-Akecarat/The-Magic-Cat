...
public class AnswerManager2_3 : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        GlobalControl.Instance.NextSceneName = "coin6";
    ...
    public void GenerateQuestion()
    {
        ...
        A_Int = System.Math.Round(Random.Range(0.00f, 9.99f), 2);
        ...
        SquareCount001.SumValue = System.Math.Round(x,2);
