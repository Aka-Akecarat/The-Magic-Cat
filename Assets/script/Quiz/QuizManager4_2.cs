...
public class QuizManager4_2 : MonoBehaviour
{
    int A;
    double B;
    ...
    void setAnswer()
    {
        ...
        {
            options[i].GetComponent<AnswerScript4_2>().isCorrect = false;
            ...
            {
                options[i].GetComponent<AnswerScript4_2>().isCorrect = true;
            }
        }
    }
    ...
    void randomQuestion()
    {
        ...
        {
            A = Random.Range(1, 9);
            B = System.Math.Round(Random.Range(1.00f, 9.99f),2);
